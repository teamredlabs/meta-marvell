...
NETMAP_DRIVERS ??= "mvpp2x"
NETMAP_ALL_DRIVERS = "ixgbe igb e1000e e1000 veth.c forcedeth.c virtio_net.c r8169.c mvpp2x"
...
do_install () {
    cd ${S}/LINUX
    oe_runmake install
    install -Dm 0644 ${WORKDIR}/mvpp2x-blacklist.conf ${D}${sysconfdir}/modprobe.d/mvpp2x-blacklist.conf
}

KERNEL_MODULE_AUTOLOAD = "netmap mvpp2x-netmap"

FILES_${PN} += "${sysconfdir}/modprobe.d/mvpp2x-blacklist.conf"

RPROVIDES_${PN} += "netmap-modules"
RREPLACES_${PN} += "netmap-modules"
RCONFLICTS_${PN} += "netmap-modules"
